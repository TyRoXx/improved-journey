...
namespace ij
{
    ...
    struct Canvas
    {
        ...
        [[nodiscard]] virtual Text CreateText(const std::string &content, FontId font, const Vector2f &position,
                                              Color fillColor, Color outlineColor, float outlineThickness) = 0;
